...
public class FoodListActivity extends Activity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        Builder adb = new Builder(FoodListActivity.this);
        listView = (ListView) findViewById(R.id.list1);
        adb.setTitle("Select");
        ...
        adb.setItems(items, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                if (items[which].equals("Delete")) {
                    ...
                    String name = c.getString(c.getColumnIndex(FoodDatabase.COL_ID));
