...
public class FruitListActivity extends Activity implements View.OnClickListener,AdapterView.OnItemClickListener {
    ...
    public void onItemClick(final AdapterView<?> parent, View view, final int position, long id) {
        Builder adb=new Builder(FruitListActivity.this);
        listView = (ListView) findViewById(R.id.list1);
        adb.setTitle("Select");
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            default:
                Toast.makeText(FruitListActivity.this,
                        "not found",
