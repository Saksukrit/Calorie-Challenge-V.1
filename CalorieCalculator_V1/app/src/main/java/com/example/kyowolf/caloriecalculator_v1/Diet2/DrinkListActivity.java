...
public class DrinkListActivity extends Activity implements View.OnClickListener,AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
        listView = (ListView) findViewById(R.id.list1);
        Builder adb=new Builder(DrinkListActivity.this);
        adb.setTitle("Select");
        ...
        adb.setItems(items, new OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                if(items[which].equals("Delete")){
                    ...
                    String name = c.getString(c.getColumnIndex(DrinkDatabase.COL_ID));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            default:
                Toast.makeText(DrinkListActivity.this,
                        "not found",
